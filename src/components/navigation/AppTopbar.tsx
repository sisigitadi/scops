      ...
      <div className="max-w-[1920px] mx-auto h-full px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 sm:gap-5">
             <button
                ...
                className="hidden md:flex items-center gap-2 px-3 py-2 rounded-xl bg-bg-panel/70 hover:bg-bg-card border border-border-primary/50 text-foreground-secondary hover:text-foreground-primary transition-all text-xs font-mono group shadow-sm"
                title="Buka Command Palette (Ctrl+K)"
             >
                <Search size={14} className="text-accent-cyan group-hover:scale-110 transition-transform" />
                <span className="text-[11px] font-sans font-medium text-foreground-tertiary">Quick Command</span>
                <kbd className="text-[10px] bg-bg-main px-1.5 py-0.5 rounded border border-border-primary/60 text-foreground-tertiary">⌘K</kbd>
             </button>
